...
public class AgenciaRepositoryTest {
	...
	public void deveSalvarUmaAgencia() {
		...
		Agencia agencia = new Agencia("0123", "5", cidade);
	...
	@Test
	public void deveBuscarAgenciasPorNumero() {
		
		Cidade cidade = cidadeRepository.save(new Cidade("Maringá", Estado.PR));
		Agencia agencia = new Agencia("0123", "5", cidade);
		agenciaRepository.save(agencia);
		
		Agencia agenciaBuscaPorNumero = agenciaRepository.findByNumero("0123");
		Assert.assertNotNull(agenciaBuscaPorNumero.getId());
